...
import { DOMView, MathCommand, MQSymbol, BinaryOperator, MathBlock, RootMathBlock } from './core'
import { EMBEDS } from '../../registry'
...
class SupSub extends MathCommand {
    ...
    contactWeld(cursor: Cursor) {
        ...
        for (var dir: Direction | false = L; dir; dir = dir === L ? R : false) {
